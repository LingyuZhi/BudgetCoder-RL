...
def test_eval_contract_and_lock():
    ...
    assert sha256_file(REPO_ROOT / "configs/experiments/stage1_m6_eval.json") == EXPECTED_EVAL_SHA256
    ...
    freeze = REPO_ROOT / "configs/experiments/stage1_m3c_freeze.json"
...
def test_contract_rejects_intermediate_checkpoints():
    payload = json.loads(
        (REPO_ROOT / "configs/experiments/stage1_m6_eval.json").read_text(encoding="utf-8")
    )
