#!/usr/bin/env bash
# Launch M5A GPU 4-step rehearsal inside tmux on n30158.
# WANDB_API_KEY must already be exported in this environment. Do not commit it.
set -uo pipefail
...
LOG_DIR="outputs/experiments/E010"
mkdir -p "$LOG_DIR"
